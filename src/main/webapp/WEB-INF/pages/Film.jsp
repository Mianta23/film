<%@page import="com.example.film.model.*,java.util.List"%>
...
<html>
    ...
    <main id="main" class="main">
        ...
        <div class="col-3">
            ...
            <form action="<%=request.getContextPath()%>/newFilm" method="post">
        ...
        <table class="table table-striped">
            ...
            <tr>
                <td><%=f.getFilm()%></td>
                <td><a href="<%=request.getContextPath()%>/liste-scene?id=<%=f.getId()%>">Voir details</a></td>
                <td><a href="<%=request.getContextPath()%>/planning?id=<%=f.getId()%>">Planning</a></td>
            </tr>
            <%}%>
        </table>
    </main>
